...
class NewMCQQuestion extends Component {
  constructor(props) {
    super(props);
    this.state = {
        formData: {
...
handle_answer_change(event) {
    ...
    // var array = this.state.formData.answer.split('').sort();
    // this.state.formData.answer = array.toString();
            ...
            <div className="card border-primary">
              ...
              <div className="card-body text-left">
                ...
                <div className="form-group">
                  ...
                  <input id="option1"  type="radio"  value="1" onChange={this.handle_answer_change} />
                  <input
                    disabled={this.state.disabled}
                    type="text"
                ...
                <div className="form-group">
                  ...
                  <input id="option2"  type="radio"  value="2" onChange={this.handle_answer_change}/>
                  <input
                    disabled={this.state.disabled}
                    type="text"
                ...
                <div className="form-group">
                  ...
                  <input id="option3" type="radio" value="3" onChange={this.handle_answer_change}/>
                  <input
                    disabled={this.state.disabled}
                    type="text"
                ...
                <div className="form-group">
                  ...
                  <input id="option4"  type="radio" value="4" onChange={this.handle_answer_change}/>
                  <input
                    disabled={this.state.disabled}
                    type="text"
...
export default withRouter(NewMCQQuestion);
