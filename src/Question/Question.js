      ...
      <div className="container">
        <div className="row">
          <div className="jumbotron col-12">
            ...
            <input type="radio" name="A" value="1" onChange={this.handle_answer_change}/>{question.option1}
            <br />
            <input type="radio" name="A" value="2" onChange={this.handle_answer_change}/>{question.option2}
            <br />
            <input type="radio" name="A" value="3" onChange={this.handle_answer_change}/>{question.option3}
            <br />
            <input type="radio" name="A" value="4" onChange={this.handle_answer_change}/>{question.option4}
            <br />
            <hr className="my-4" />
            <button
